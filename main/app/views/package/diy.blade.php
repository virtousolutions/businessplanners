...
<div class="container" style="margin-top: 30px; margin-bottom: 45px;">
    ...
    <div style="margin-top: 20px;">
        ...
        <p>That's why with our VALUE business plan, creating your own business plan has never been easier. Our award-winning business-planning platform will guide you through everything that you need to include, explaining each section and helping you along the way. Writing your own business plan has never been easier.</p>
        <br>
        <p><strong>Benefits of the VALUE business plan package:</strong></p>
        ...
        <br>
        <p><strong>With the VALUE business plan package, you receive:</strong></p>
        <ul style="margin-left: 45px;">
        ...
        <br>
        <p>For just &pound;199, the VALUE business plan package is fantastic for those on a budget who wish to create their own business plan, but need a bit of guidance along the way.
        </p>
