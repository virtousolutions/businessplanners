...
<div class="container" style="margin-top: 30px; margin-bottom: 45px;">
    <h2>Raise finances and venture capital with a premium written business plan</h2>
    ...
    <div style="margin-top: 20px;">
        ...
        <ul style="margin-left: 45px;">
            <li>A full, premium written business plan</li>
            <li>Your own dedicated accounts manager</li>
            <li>Your own dedicated researcher</li>
            <li>3 years of financial forecasting, by a premium qualified financial accountant</li>
